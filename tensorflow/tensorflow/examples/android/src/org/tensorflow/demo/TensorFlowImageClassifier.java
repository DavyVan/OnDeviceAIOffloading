...
//        Trace.endSection();
        ...
        // Output Nodes
        String[] outputNodes = new String[]{outputNames[0]};
        odims.put(outputNames[0], new long[]{outputs.length});

        // commit
        int errno = offloadingSystem.commit(modelFileName, "TF Demo Classify", inputNodes, inputValues, dims, outputNodes, odims);
        /**
...
//        return recognitions;
    ...
    public String getStatString() {
        /**
         * Offloading - We don't use this inferenceInterface instance
         */
//        return inferenceInterface.getStatString();
        return "";
        /**
         * Offloading - We don't use this inferenceInterface instance - End
         */
    }
    ...
    public void initOffloading(final ClassifierActivity activity) {
        onResultHandler = new Handler(activity.handlerThread.getLooper()) {
            ...
            public void handleMessage(Message msg) {
                ...
                // Prepare data
                System.arraycopy(task.outputs.get(outputName), 0, outputs, 0, task.outputs.get(outputName).length);
                ...
                activity.resultsView.setResults(recognitions);
